...
This section contains some stand-alone script examples of how you can use `HttpBuilder`. You can copy them and run them in the Groovy Shell
or there are unit test versions for most of these examples in the `ExamplesSpec.groovy` file.
...
TODO: make this one post to httpbin or something so that it can be a script
